...
SuperModule enables continuing to use Ruby module support the basic way (with mixin inheritance) even when wanting to inherit singleton-class methods and invocations.
