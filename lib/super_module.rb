...
module SuperModule
  module ModuleBodyMethodRecorder
  ...
  module SingletonMethodDefinitionStore
        ...
        def self.extended(base)
          include SuperModule::ModuleBodyMethodRecorder unless base.singleton_class.include?(SuperModule::ModuleBodyMethodRecorder)
  ...
  def self.included(original_base)
    original_base.class_eval do
      extend SuperModule::ModuleBodyMethodRecorder
